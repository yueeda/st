...
\input{preamble}
\lhead{{\itshape Summa Theologiae} I, q.~11}
%--------------------

\bibliographystyle{jplain}
\title{{\bfseries Prima Pars}\\{\Huge Summae Theologiae}\\Sancti Thomae
Aquinatis\\Quaestio Undecima\\{\bfseries De Unitate Dei}}
...
{\scshape Sed contra est} quod dicit Dionysius, ult.~cap.~{\itshape de Div.~Nom.}, {\itshape nihil est
...
{\scshape Respondeo dicendum} quod unum non addit supra ens rem aliquam,
...
ult.~cap.~{\itshape de Div.~Nom.}, quod {\itshape non est multitudo non
...
est multitudo mensurata per unum, ut patet ex {\itshape X Metaphys}. Unum vero quod
...
{\huge A}{\scshape d tertium sic proceditur}. Videtur quod Deus non sit
 unus. Dicitur enim I {\itshape ad Cor}.~{\scshape viii}, siquidem sunt dii multi et domini multi.
...
Sed contra est quod dicitur {\itshape Deut}.~{\scshape vi}, {\itshape Audi,
...
suam essentiam, ut patet per philosophum in IV {\itshape Metaphys}. Ergo omne ens
...
{\bfseries Sed contra} est quod dicit Bernardus, quod {\itshape inter omnia quae unum
