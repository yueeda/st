...
\lhead{{\itshape Summa Theologiae} I, q.~89}

\title{{\bfseries Prima Pars}\\{\Huge Summae Theologiae}\\Sancti Thomae
Aquinatis\\{\sffamily Quaestio Octogesimanona}\\{\bfseries De Cognitione Animae Separatae}}
...
\begin{center}
{\bfseries \Large ARTICULUS PRIMUS}\\
{\large UTRUM ANIMA SEPARATA ALIQUID INTELLIGERE POSSIT}\\
{\footnotesize III {\itshape Sent.}, d.~31, q.~2, a.~4; IV, d.~1, q.~1, a.~1; II
 {\itshape SCG.},
 c.~81; {\itshape De Verit.}, q.~19, a.~1; {\itshape de Anima}, a.~15; {\itshape Quodl.}~III, q.~9,
 a.~1.}
...
{\huge A}{\scshape d primum sic proceditur}. Videtur quod anima separata nihil omnino
 intelligere possit. Dicit enim philosophus, in I {\itshape de
 anima}\footnote{Cap.~4, n.~14. S.Th.~lect.~x.}, quod
 {\itshape intelligere corrumpitur, interius quodam corrupto}. Sed omnia interiora
...
2.~{\scshape Praeterea}, anima humana impeditur ab intelligendo per
ligamentum
...
3.~{\scshape Praeterea}, si anima separata intelligit, oportet quod per
aliquas species intelligat. Sed non intelligit per species innatas,
quia a principio est sicut {\itshape tabula in qua nihil est
scriptum}\footnote{Arist.~{\itshape de Anima}, III, cap.~4,
...
{\scshape Sed contra est quod} philosophus dicit, in I {\itshape de
...
{\scshape Respondeo dicendum quod} ista quaestio difficultatem habet ex hoc
...
{\scshape Ad primum ergo dicendum} quod, si diligenter verba philosophi
discutiantur,
%\footnote
...
{\scshape Ad tertium dicendum} quod anima separata non intelligit per species
...
\begin{center}
{\Large {\bfseries ARTICULUS SECUNDUS}}\\ {\large UTRUM ANIMA SEPARATA
INTELLIGAT SUBSTANTIAS SEPARATAS}\\ {\footnotesize III {\itshape SCG},
c.~14; {\itshape Qu.~de Anima}, a.~17; {\itshape Quodl}.~III, q.~9, a.~1.}\\
...
{\huge A}{\scshape d secundum sic proceditur}. Videtur quod anima separata
...
は、上で述べられたとおり\footnote{{\itshape ST} I, q.~88, a.~1}、離在実体を
...
2 {\scshape Praeterea}, omne quod cognoscitur, vel cognoscitur per sui
...
3 {\scshape Praeterea}, quidam philosophi posuerunt in cognitione
...
さらに、ある哲学者たちは\footnote{Averroes. cf. {\itshape ST} I, q.~88,
...
{\scshape Sed contra est} quod animae separatae cognoscunt alias animas
...
{\scshape Respondeo dicendum} quod, sicut Augustinus dicit in IX {\itshape de
Trin}.: {\itshape Mens nostra cognitionem rerum incorporearum per seipsam
...
separatae quod intelligat {\itshape id quod est supra se, et id quod est
...
{\scshape Ad primum ergo dicendum} quod anima separata est quidem
...
{\scshape Ad secundum dicendum} quod anima separata intelligit Angelos per
...
{\scshape Ad tertium dicendum} quod in cognitione substantiarum separatarum
...
\begin{center}
{\Large {\bfseries ARTICULUS TERTIUS}}\\ {\large UTRUM ANIMA SEPARATA OMNIA
NATURALIA COGNOSCAT}\\ {\footnotesize {\itshape Q.~de Anima}, a.~18.}\\
...
{\huge A}{\scshape d tertium sic proceditur}. Videtur quod anima separata
...
2 {\scshape Praeterea}, qui intelligit magis intelligibile, multo magis
...
{\scshape Sed contra}, in Daemonibus magis viget
%\footnote{v\u{\i}g\u{e}o , \={e}re, v.~n.~Sanscr.~ugras, mighty; Gr. ὑγιής, sound; cf.~Lat.~vegeo, vigil, augeo,
...
experientiam, ut Isidorus dicit.\footnote{{\itshape Sententiarum} (al. {\itshape
de Summo Bono}) lib. I, cap.~10, al.~19. Cf. August. {\itshape de
...
2 {\scshape Praeterea}, si anima statim cum est separata, omnia naturalia
...
{\scshape Respondeo dicendum} quod, sicut supra dictum est, anima separata
...
angelica, ut dicit Augustinus, {\itshape super Gen.~ad Litt}. Unde et
...
{\scshape Ad primum ergo dicendum} quod nec ipse Angelus per suam
...
{\scshape Ad secundum dicendum} quod, sicut anima separata non perfecte
...
{\scshape Ad tertium dicendum} quod Isidorus loquitur de cognitione
...
{\scshape Ad quartum dicendum} quod cognitio quae acquiritur hic per
...
\begin{center}
{\Large {\bfseries ARTICULUS QUARTUS}}\\ {\large UTRUM ANIMA SEPARATA
COGNOSCAT SINGULARIA}\\ {\footnotesize IV {\itshape Sent}., d.~50, q.~1,
a.~3; {\itshape De Verit}., q.~19, a.~2; {\itshape Qu.~de Anima}, a.~20.}\\
{\Large 第4項\\分離した魂は個物を認識するか}
\end{center}

\begin{longtable}{p{21em}p{21em}}
{\huge A}{\scshape d quartum sic proceditur}. Videtur quod anima separata
...
2 {\scshape Praeterea}, magis est determinata cognitio qua cognoscitur
...
3 {\scshape Praeterea}, si cognoscit singularia, et non per sensum, pari
...
{\scshape Sed contra est} quod dives in inferno positus dixit: {\itshape Habeo
quinque fratres}, ut habetur Luc.~{\scshape xvi}.
...
{\scshape Respondeo dicendum} quod animae separatae aliqua singularia
...
されえず、上述のごとく、
%\footnote{{\itshape ST} I, q.~86, a.~1.
...
%intelligibiles intelligit, ut dicitur in III {\itshape de Anima}. Sic igitur ipsum
...
{\scshape Ad primum ergo dicendum} quod intellectus per viam abstractionis
...
\begin{center}
{\Large {\bfseries ARTICULUS QUINTUS}}\\ {\large UTRUM HABITUS SCIENTIAE HIC
ACQUISITAE\\ REMANEAT IN ANIMA SEPARATA}\\ {\footnotesize {\itshape ST}
I-IIae, q.~67, a.~2; {\itshape IV Sent.}, d.~1, q.~1, a.~2; {\itshape
Quodl.}~XII, q.~9, a.~1; {\itshape I Cor.}, c.~13, l.~3.}\\ {\Large 第5項\\
...
{\huge A}{\scshape d quintum sic proceditur}. Videtur quod habitus
scientiae hic acquisitae non remaneat in anima separata. Dicit enim
apostolus, I {\itshape ad Cor}.~{\scshape xiii}: {\itshape Scientia destruetur}.
...
2. {\scshape Praeterea}, quidam minus boni in hoc mundo scientia pollent,
...
3. {\scshape Praeterea}, animae separatae habebunt scientiam per
...
4. {\scshape Praeterea}, philosophus dicit, in libro {\itshape Praedicament}.,
quod {\itshape habitus est qualitas difficile mobilis; sed ab aegritudine,
...
{\scshape Sed contra est} quod Hieronymus dicit, in Epistola {\itshape ad
Paulinum}: {\itshape discamus in terris, quorum scientia nobis perseveret
in caelo}.
...
{\scshape Respondeo dicendum} quod quidam posuerunt habitum scientiae non
...
答えて言わなければならない。ある人々\footnote{cf. Avicenna {\itshape de
...
Sed quia scientia est in intellectu, qui est {\itshape locus specierum}, ut
dicitur in III de {\itshape Anima}; oportet quod habitus scientiae hic
...
habitus scientiae acquiritur, nam {\itshape habitus sunt similes actibus ex
quibus acquiruntur}, ut dicitur in II {\itshape Ethic}. Actus autem
...
dicitur in libro de {\itshape Longitudine et Brevitate Vitae}, dupliciter
...
% られているが、三通りに区別されることもある。cf. {\itshape SCG} II, c.~79, n.~10. ``Item. Nulla forma corrumpitur nisi vel ex actione
...
{\scshape Ad primum ergo dicendum} quod apostolus non loquitur ibi de
scientia quantum ad habitum, sed quantum ad cognitionis actum. Unde ad
huius probationem inducit, {\itshape Nunc cognosco ex parte}.
...
{\scshape Ad secundum dicendum} quod, sicut secundum staturam
...
{\scshape Ad quartum dicendum} quod ratio illa procedit de corruptione
...
\begin{center}
{\Large {\bfseries ARTICULUS SEXTUS}}\\ {\large UTRUM ACTUS SCIENTIAE HIC
ACQUISITAE MANEAT IN ANIMA SEPARATA}\\ {\footnotesize III {\itshape Sent.},
...
{\huge A}{\scshape d sextum sic proceditur}. Videtur quod actus scientiae
hic acquisitae non maneat in anima separata. Dicit enim philosophus,
in I {\itshape de Anima}, quod corrupto corpore, anima {\itshape neque
...
2. {\scshape Praeterea}, species intelligibiles non erunt potentiores in
...
3. {\scshape Praeterea}, philosophus dicit, in II {\itshape Ethic}., quod {\itshape
...
{\itshape Sed contra est quod} Luc.~{\scshape xvi}, dicitur ad divitem in
Inferno positum, {\itshape Recordare quia recepisti bona in vita tua}.
...
{\scshape Respondeo dicendum} quod in actu est duo considerare, scilicet
...
{\scshape Ad secundum dicendum} quod diversus modus intelligendi non
...
{\scshape Ad tertium dicendum} quod actus per quos acquiritur habitus, sunt
...
て、楽しみのために働く。\footnote{Cf.~Arist.~{\itshape Ethic.}, lib.~5,
c.~8, n.~1. (s.Th.~lect. 13); {\itshape Magn.Moral}., lib.~1, cap.~34,
n.~23.}
...
\begin{center}
{\Large {\bfseries ARTICULUS SEPTIMUS}}\\ {\large UTRUM DISTANTIA LOCALIS
IMPEDIAT COGNITIONEM ANIMAE SEPARATAE}\\ {\footnotesize IV {\itshape
...
{\huge A}{\scshape d septimum sic proceditur}. Videtur quod distantia
localis impediat cognitionem animae separatae. Dicit enim Augustinus,
in libro {\itshape de Cura pro Mortuis agenda}, quod {\itshape animae mortuorum
...
2. {\scshape Praeterea}, Augustinus dicit, in libro {\itshape de Divinatione
Daemonum}, quod {\itshape daemones, propter celeritatem motus, aliqua nobis
...
3. {\scshape Praeterea}, sicut distat aliquis secundum locum, ita secundum
...
{\scshape Sed contra est} quod dicitur Luc.~{\scshape xvi}, quod {\itshape dives cum
...
{\scshape Respondeo dicendum} quod quidam posuerunt quod anima separata
...
{\scshape Ad primum ergo dicendum} quod Augustinus non dicit quod propter
...
{\scshape Ad secundum dicendum} quod Augustinus ibi loquitur secundum
...
tangere videatur, ut patet per ea quae dicit XXI libro {\itshape de
Civ.~Dei}.
...
{\scshape Ad tertium dicendum} quod futura, quae distant secundum tempus,
...
\begin{center}
{\Large {\bfseries ARTICULUS OCTAVUS}}\\ {\large UTRUM ANIMAE SEPARATAE
COGNOSCAT EA QUAE HIC AGUNTUR}\\ {\footnotesize {\itshape ST} II-II, q.~83,
a.~4, ad 2; IV {\itshape Sent.}, d.~45, q.~3, a.~1, ad 1, 2; d.~1, q.~1,
a.~4, ad 1; {\itshape De Verit.}, q.~8, a.~2, ad 12; q.~9, a.~6, ad 5;
Qu.~{\itshape de Anima.}, a.~20, ad 3.}\\ {\Large 第8項\\分離した魂は、この
世で為されていることを認識するか}
\end{center}
...
{\huge A}{\scshape d octavum sic proceditur}. Videtur quod animae separatae
...
illud Luc. {\scshape xvi}: {\itshape Habeo quinque fratres, ut testificetur
...
2.{\scshape Praeterea}, frequenter mortui vivis apparent, vel dormientibus
vel vigilantibus, et eos admonent de iis quae hic aguntur; sicut
Samuel apparuit Sauli, ut habetur I {\itshape Reg}.~{\scshape xxviii}. Sed hoc
...
3. {\scshape Praeterea}, animae separatae cognoscunt ea quae apud eas
...
{\scshape Sed contra est} quod dicitur {\itshape Iob} {\scshape xiv} : {\itshape Sive
...
{\scshape Respondeo dicendum} quod, secundum naturalem cognitionem, de qua
...
Et hanc rationem assignat Gregorius in XII {\itshape Moralium}, dicens:
{\itshape Mmortui vita in carne viventium post eos, qualiter disponatur,
...
cognitione}. Et hoc etiam Augustinus videtur tangere in libro {\itshape de
Cura pro Mortuis agenda}, dicens {\itshape quod animae mortuorum rebus
...
Gregorium et Augustinum. Nam Gregorius ibidem subdit: {\itshape Quod tamen
...
quod ignorent}. -- Augustinus vero, in libro {\itshape de Cura pro Mortuis
agenda}, expresse dicit quod {\itshape nesciunt mortui, etiam sancti, quid
agant vivi et eorum filii}, ut habetur in Glossa, super illud, {\itshape
Abraham nescivit nos}, Isaiae {\scshape lxiii}.
...
superventura, ut habetur IV {\itshape Reg}.~{\scshape xxii}. Sed Augustinus hoc
dubitando dicit, unde praemittit, {\itshape ut volet, accipiat quisque quod
dicam}. Gregorius autem assertive, quod patet per hoc quod dicit, {\itshape
...
{\scshape Ad primum ergo dicendum} quod animae mortuorum possunt habere
...
Angelos seu Daemones; vel etiam {\itshape spiritu Dei revelante}, sicut
...
{\scshape Ad secundum dicendum} quod hoc quod mortui viventibus apparent
...
{\itshape Eccli}.~{\scshape xlvi}, quod {\itshape dormivit, et notum fecit regi finem
...
{\scshape Ad tertium dicendum} quod ignorantia huiusmodi non contingit ex
