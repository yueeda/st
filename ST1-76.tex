...
によって動かされる。\footnote{知性が身体を動かすとき、欲求を通して動かす。しかしその欲求は、知性を前提とする。つまり、\\
1. 知性が目的を認識し、\\
2. その目的へと欲求が身体を動かす\\
という順序である。ソクラテスが知性に動かされているから、ソクラテスが認識するのではなく、そもそもソクラテスが認識することが始まりで、その結果、欲求を通してソクラテスが動かされる。知性が動因であるためには、そもそもその認識がソクラテスに属していることが前提である。}
...
\switchcolumn*[\subsection{ad 1}]
 ...
 てある。彼はこのことを、「人間が質料から人間を生み、太陽もまた」\footnote{\foreignlanguage{greek}{ἄνθρωπος γὰρ ἄνθρωπον γεννᾷ καὶ ἥλιος.}
--- Aristotle, \textit{Physica}, II, 2, 194b13
}ということから証明する。
