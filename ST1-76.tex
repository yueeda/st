...
corporis\footnote{potentia receptiva quae[cumque] est actus alicuius corporis...
と解する。}, recipit formam materialiter et individualiter, quia receptum est in
recipiente secundum modum recipientis. Sed forma rei intellectae non recipitur
in intellectu materialiter et individualiter, sed magis immaterialiter et
universaliter, alioquin intellectus non esset cognoscitivus immaterialium et
universalium, sed singularium tantum, sicut et sensus. Intellectus ergo non
...
\switchcolumn
 ...
 出てくるところの本質よりも、切り離されていたり、あるいは単純であること
 はできない。ゆえに知性の実体も、身体の形相ではない。
...
\switchcolumn
 ...
 る）ように自ら全体に即してか、人間が目を通して見る場合のように部分に
...
これは異端である。なぜなら、賞罰の差異がなくなるからである。\footnote{1. 原因が
取り除かれると、結果も取り除かれる。\\2. 身体の多数性が、魂の多数性の原因である。
\\2. 身体の多数性がなくなると、魂の多数性もなくなる。\\3. これは異端である。(こ
れは矛盾である。)\\4. ゆえに、身体の多数性が魂の多数性の原因ではない。\\5. 身体
が多数あっても魂は多数化されない。\\では、これは異端でないのか?という疑問が残る。}
...
\switchcolumn
 ...
 一つである魂が、種において異なる魂に属することは不可能である。ゆえに、数的に一
 つの知性的魂が、数的に多数のものに属することは不可能である。
...
の期間によっても生じないことを私たちが加えるならば、さらに、一つの作用者でありま
...
anima intellectiva est incorruptibilis; aliae vero animae, scilicet sensitiva et nutritiva, sunt corruptibiles, ut ex superioribus patet. Ergo in homine non
