...
\input{preamble}
\lhead{{\itshape Summa Theologiae} III, q.~75}
%--------------------

\bibliographystyle{jplain}

\title{{\bfseries TERTIA PARS}\\{\Huge Summae Theologiae}\\Sancti Thomae
...
\rhead{a.~2}
\begin{center}
{\Large {\bfseries ARTICULUS SECUNDUS}}\\ {\large UTRUM IN HOC SACRAMENTO
...
\rhead{a.~3}
\begin{center}
{\Large {\bfseries ARTICULUS TERTIUS}}\\ {\large UTRUM SUBSTANTIA PANIS,
...
\rhead{a.~4}
\begin{center}
{\Large {\bfseries ARTICULUS QUARTUS}}\\ {\large UTRUM PANIS POSSIT CONVERTI
...
\rhead{a.~5}
\begin{center}
{\Large {\bfseries ARTICULUS QUINTUS}}\\ {\large UTRUM IN HOC SACRAMENTO
