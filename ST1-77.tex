...
\title{{\bfseries Prima Pars}\\{\Huge Summae Theologiae}\\Sancti Thomae Aquinatis\\{\sffamily Quaestio Septuagesimaseptima}\\{\bfseries DE HIS QUAE PERTINENT AD POTENTIAS ANIMAE IN GENERALI}}
...
\rhead{a.1}
\section{UTRUM IPSA ESSENTIA ANIMAE SIT EIUS POTENTIA}
\noindent {\large 魂の本質それ自体がその能力か}\\
\vspace{1em}
...
第一に、可能態(potentia)と現実態(actus)は、何であれ有の類を分割するので、可能態と
現実態は、有と同一の類に還元されなければならない。ゆえに、もし現実態が実体の類に
ないならば、その現実態に対して語られる可能態もまた、実体の類の中にはありえない。
...
\textsc{Ad secundum dicendum} quod actus ad quem est in potentia
...
\switchcolumn
 ...
 \textsc{Ad tertium dicendum} quod actio est
 compositi, sicut et esse, existentis enim est agere. Compositum autem per
 formam substantialem habet esse substantialiter; per virtutem autem quae
 consequitur formam substantialem, operatur. Unde sic se habet forma
 accidentalis activa ad formam substantialem agentis (ut calor ad formam ignis),
 sicut se habet potentia animae ad animam.
...
\rhead{a.2}
\section{UTRUM SINT PLURES POTENTIAE ANIMAE}
\vspace{1em}
\noindent {\LARGE \textbf{複数の能力が魂にはあるか}}\\
\vspace{1em}
...
\rhead{a.3}
\section {UTRUM POTENTIAE DISTINGUANTUR PER ACTUS ET OBIECTA}
{\footnotesize Qu.~{\itshape de Anima}, a.13; lib.~II {\itshape de Anima}, lect.~6.}\\

\vspace{2em}
\textbf{{\Large 第三項　能力は作用と対象によって区別されるか}}
\vspace{2em}
...
\rhead{a.4}
\section{UTRUM IN POTENTIIS ANIMAE SIT ORDO}
{\footnotesize Qu.~{\itshape de Anima}, art.13, ad 10.}

\vspace{1em}
\textbf{{\Large 第四項  魂の諸能力の中に秩序があるか}}
\vspace{2em}
...
解答する。以下のように言われるべきである。魂は一つであり能力は複数であるが、一から多へと進められるのは何らかの秩序によってだから、魂の諸能力の間に何らかの秩序があるのは必然である。

\switchcolumn*


Triplex autem ordo inter eas attenditur. Quorum duo considerantur secundum
dependentiam unius potentiae ab altera, tertius autem accipitur secundum ordinem
obiectorum.
 
\switchcolumn

  しかるに、それらの間には、三通りの仕方で秩序が見出される。そのうちの二つは、一つの能力の他の能力への依存に従って考察され、三番目は、対象の秩序に従って了解される。  
