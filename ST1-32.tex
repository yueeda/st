...
\input{preamble}
\lhead{{\itshape Summa Theologiae} I, q.~32}
%--------------------
...
&
 ...
 ゆえに、自然本性的理性によって神について認識されうるのは、すべての存在者の根
 源である限りにおいて必然的に神に適合するものだけであり、この基本を私たちは神についての
 考察において前に用いた。しかし神の創造する力は三性全体に共通であり、したがって
 それは本質の一性に属するのでありペルソナの区別に属するのではない。ゆえに神につ
 いて自然本性的理性によって本質の一性に属することは認識されうるが、ペルソナの区
 別に属することは認識されえない。
