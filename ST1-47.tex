...
\input{preamble}
\lhead{{\itshape Summa Theologiae} I, q.~47}
%--------------------

\bibliographystyle{jplain}

\title{{\bfseries Prima Pars}\\{\Huge Summa Theologiae}\\Sancti Thomae
Aquinatis\\Quaestio QUDRAGESIMASEPTIMA\\{\bfseries DE DISTINCTIONE RERUM IN COMMUNI}}
...
{\huge P}{\scshape ost} productionem creaturarum in esse,
...
\begin{center}
 ...
 {\footnotesize II {\itshape SCG.}, c.~34 usque 45 inlusu.; lib.~III, c.~97;
 {\itshape De Pot.}, q.~3, a.~1, ad 9; a.~16; {\itshape Compend.~Theol.}, c.~72, 102;
 XII {\itshape Metaphysic.}, l.~2; {\itshape De Causis,} l.~24.}\\
...
2.~{\scshape Praeterea}, exemplatum assimilatur suo
...
3.~{\scshape Praeterea}, ea quae sunt ad finem,
...
{\scshape Sed contra est} quod dicitur {\itshape Gen.}~{\scshape i}, quod {\itshape Deus
 distinxit lucem a tenebris}, et {\itshape divisit aquas ab aquis}. Ergo
...
{\scshape Respondeo dicendum} quod causam distinctionis
...
Unde dicendum est quod distinctio rerum et multitudo est ex intentione
 ...
 dicitur {\itshape Gen}.~{\scshape i} : {\scshape Dixit Deus, fiat lux. Et divisit
 lucem a tenebris}.
...
{\scshape Ad primum ergo dicendum} quod agens per
...
{\scshape Ad secundum dicendum} quod ratio illa teneret
...
{\scshape Ad tertium dicendum} quod in speculativis
...
\begin{center}
 ...
 {\footnotesize Infra q.~65, a.~2; II {\itshape SCG.}, c.~44, 45; III, c.~97;
...
{\huge A}{\scshape d secundum} sic proceditur. Videtur quod inaequalitas
