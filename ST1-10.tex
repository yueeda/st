...
\input{preamble}
\lhead{{\itshape Summa Theologiae} I, q.~10}
%--------------------


\bibliographystyle{jplain}
\title{{\bfseries Prima Pars}\\{\Huge Summae Theologiae}\\Sancti Thomae
Aquinatis\\Quaestio Decima\\{\bfseries De Dei Aeternitate}}
...
aeternitatis, quam Boetius ponit V {\itshape de Consolatione}, dicens quod
{\itshape aeternitas est interminabilis vitae tota simul et perfecta
...
enim {\itshape Micheae} {\scshape v} : {\itshape egressus eius ab initio, a
diebus aeternitatis}; et {\itshape ad Rom.}, {\scshape xvi} cap: {\itshape
...
habent in tempore, ut dicitur in IV {\itshape Physic.}, et hoc ideo, quia in
...
aeternitatem}; et Augustinus dicit, in libro {\itshape Octoginta trium Quaest.},
...
libro {\itshape de Causis}, et post aeternitatem; dicitur enim {\itshape Exod. XV}, quod
{\itshape dominus regnabit in aeternum et ultra}. Ergo esse aeternum non convenit
Deo.
&
...
ibidem dicitur, quod {\itshape intelligentia parificatur aeternitati}. 
...
-- Quod autem
dicitur in {\itshape Exodo}, {\itshape dominus regnabit in aeternum et ultra
...
non sit soli Deo proprium. Dicitur enim {\itshape Danielis XII}, quod
...
2.~{\scshape Praeterea}, {\itshape Matth}.~{\scshape xxv} dicitur, {\itshape
...
nunquam esse desinunt, et secundum hoc dicitur {\itshape Eccle}.~{\scshape
...
durationis, licet corruptibilia sint, sicut in {\itshape Psalmo} dicuntur
{\itshape montes aeterni}; et {\itshape Deuter}.~{\scshape xxxiii} etiam dicitur, {\itshape de
...
dicit Augustinus, XV {\itshape de Trin.} Unde et videntes Deum dicuntur
habere vitam aeternam, secundum illud {\itshape Ioann}.~{\scshape xvii}, {\itshape haec
...
transmutatio, secundum illud {\itshape Iob} {\scshape xxiv}, {\itshape ad nimium
calorem transibunt ab aquis nivium}. Unde in Inferno non est vera
aeternitas, sed magis tempus; secundum illud {\itshape Psalmi}, {\itshape erit tempus
eorum in saecula}.
...
veritatis. Verum autem, secundum philosophum, VI {\itshape Metaphys.}, est in
...
2.~{\scshape Praeterea}, secundum philosophum in IV {\itshape Physic.},
...
motuum, ut dicitur in IV {\itshape Physic.}, ita videtur quod mensura primi esse
...
aeternitatem et tempus, ut dicit Boetius in libro {\itshape de Consolat.}, ex
...
dicitur in IV {\itshape Physic}. Unde si motus caeli semper duraret, tempus
...
{\huge A}{\scshape d quintum sic proceditur}. Videtur quod aevum non sit
 aliud a tempore. Dicit enim Augustinus, VIII {\itshape super Gen.~ad Litt.},
...
2.~{\scshape Praeterea}, de ratione temporis est quod habeat prius et
 ...
 dictum est. Sed aevum non est aeternitas, dicitur enim {\itshape Eccli. I},
...
posterius in mensura, ut patet ex IV {\itshape Physic}. Si igitur ipsum aeviternum
...
{\itshape ST} 1, 66（山田）}は、ただ一つの永劫があると言い、別の人々
\footnote{Bonaventura (1221 -- 15 July 1274), {\itshape In II Sent}., d. 2,
...
1198). cf. Aquinas's {\itshape In II Sent}., d. 2, q. 1, a. 2（山田）}、す
...
sit simplicissimus, omnes alii mensurantur, ut dicitur in X {\itshape Metaphys}.

&

ゆえに、時間の一性の根拠は、『形而上学』第10巻で言われるように、もっと
も単純であるために、他のすべての運動がそれによって測られる、第一の運動
\footnote{cf. {\itshape In VIII Physic.}, l. 23 n. 5. Huius igitur rationis
...
{\bfseries unus qui est totius firmamenti, quo scilicet totum firmamentum
...
cap.~{\scshape x} {\itshape Cael.~Hier.}, quod inter substantias spirituales
...
generis, ut dicitur in X {\itshape Metaphys.}, oportet quod esse omnium
